...
return [
	'routes' => [
		...
		// Client File routes
		['name' => 'client_file#index', 'url' => '/api/clients/{clientId}/files', 'verb' => 'GET'],
		['name' => 'client_file#upload', 'url' => '/api/clients/{clientId}/files', 'verb' => 'POST'],
		['name' => 'client_file#download', 'url' => '/api/clients/{clientId}/files/{fileName}', 'verb' => 'GET'],
		['name' => 'client_file#delete', 'url' => '/api/clients/{clientId}/files/{fileName}', 'verb' => 'DELETE'],
		...
		// Inventory routes
		['name' => 'inventory#index', 'url' => '/api/inventory', 'verb' => 'GET'],
		['name' => 'inventory#show', 'url' => '/api/inventory/{id}', 'verb' => 'GET'],
		['name' => 'inventory#byCategory', 'url' => '/api/inventory/category/{categoryId}', 'verb' => 'GET'],
		['name' => 'inventory#byWarehouse', 'url' => '/api/inventory/warehouse/{warehouseId}', 'verb' => 'GET'],
		['name' => 'inventory#create', 'url' => '/api/inventory', 'verb' => 'POST'],
		['name' => 'inventory#update', 'url' => '/api/inventory/{id}', 'verb' => 'PUT'],
		['name' => 'inventory#destroy', 'url' => '/api/inventory/{id}', 'verb' => 'DELETE'],
		...
		['name' => 'warehouse#index', 'url' => '/api/warehouses', 'verb' => 'GET'],
		['name' => 'warehouse#create', 'url' => '/api/warehouses', 'verb' => 'POST'],
		['name' => 'warehouse#update', 'url' => '/api/warehouses/{id}', 'verb' => 'PUT'],
		['name' => 'warehouse#destroy', 'url' => '/api/warehouses/{id}', 'verb' => 'DELETE'],

		// Inventory Images
		['name' => 'inventory_image#index', 'url' => '/api/inventory/{inventoryId}/images', 'verb' => 'GET'],
		['name' => 'inventory_image#upload', 'url' => '/api/inventory/{inventoryId}/images', 'verb' => 'POST'],
		['name' => 'inventory_image#setPrimary', 'url' => '/api/inventory/images/{id}/primary', 'verb' => 'PUT'],
		['name' => 'inventory_image#updateOrder', 'url' => '/api/inventory/{inventoryId}/images/order', 'verb' => 'PUT'],
		['name' => 'inventory_image#destroy', 'url' => '/api/inventory/images/{id}', 'verb' => 'DELETE'],

		// POS (Point of Sale)
		['name' => 'pos#createOrder', 'url' => '/api/pos/orders', 'verb' => 'POST'],
		['name' => 'pos#createTransaction', 'url' => '/api/pos/transactions', 'verb' => 'POST'],
		['name' => 'pos#getRecentSales', 'url' => '/api/pos/sales', 'verb' => 'GET'],
		['name' => 'pos#getActiveRentals', 'url' => '/api/pos/rentals', 'verb' => 'GET'],
		['name' => 'pos#getReturns', 'url' => '/api/pos/returns', 'verb' => 'GET'],
		['name' => 'pos#returnRental', 'url' => '/api/pos/rentals/{id}/return', 'verb' => 'POST'],
		['name' => 'pos#returnSale', 'url' => '/api/pos/sales/{id}/return', 'verb' => 'POST'],
		['name' => 'pos#getMovementsByInventory', 'url' => '/api/pos/inventory/{inventoryId}/movements', 'verb' => 'GET'],
		['name' => 'pos#getOrder', 'url' => '/api/pos/orders/{id}', 'verb' => 'GET'],

		// Settings routes (Cache Refresh)
