export declare interface AvatarUrlOptions {
    /**
 ...
 */
export declare function generateAvatarUrl(user: string, options?: AvatarUrlOptions): string;
 ...
 */
export declare function linkTo(app: string, file: string): string;
