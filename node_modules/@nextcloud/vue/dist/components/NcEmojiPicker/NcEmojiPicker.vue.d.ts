    ...
    NcTextField: {
        new (...args: any[]): import('vue').CreateComponentPublicInstanceWithMixins<Readonly<{
            ...
            inputField: ({
                ...
                /** @type { typeof __VLS_ctx.picker } */ ...args: any) => infer R ? (...args: [R, R, import('@vue/reactivity').OnCleanup]) => any : (...args: [any, any, import('@vue/reactivity').OnCleanup]) => any, options?: import('vue').WatchOptions): import('vue').WatchStopHandle;
            } & Readonly<{
                id: string;
                type: "text" | "password" | "email" | "tel" | "url" | "search" | "number";
                label: string;
