...
class DomainController extends Controller {
	...
	public function update(int $id): JSONResponse {
		try {
			...
			if (isset($data['clientId'])) $domain->setClientId((int)$data['clientId']);
			if (isset($data['domainName']) && $data['domainName'] !== '') $domain->setDomainName($data['domainName']);
			if (isset($data['registrar'])) $domain->setRegistrar($data['registrar']);
			if (isset($data['registrationDate'])) $domain->setRegistrationDate($data['registrationDate']);
			if (isset($data['expirationDate'])) $domain->setExpirationDate($data['expirationDate']);
			if (isset($data['price'])) $domain->setPrice((float)$data['price']);
			if (isset($data['currency'])) $domain->setCurrency($data['currency']);
			if (isset($data['renewalInterval'])) $domain->setRenewalInterval($data['renewalInterval']);
			if (isset($data['notes'])) $domain->setNotes($data['notes']);
			if (isset($data['panelNotes'])) $domain->setPanelNotes($data['panelNotes']);
			if (isset($data['renewalHistory'])) $domain->setRenewalHistory($data['renewalHistory']);
