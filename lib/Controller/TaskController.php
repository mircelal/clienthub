...
class TaskController extends Controller {
	...
	public function update(int $id): JSONResponse {
		try {
			...
			if (isset($data['projectId'])) $task->setProjectId((int)$data['projectId'] ?: null);
			if (isset($data['clientId'])) $task->setClientId((int)$data['clientId'] ?: null);
			if (isset($data['title']) && $data['title'] !== '') $task->setTitle($data['title']);
			...
			if (isset($data['dueDate'])) $task->setDueDate($data['dueDate']);
