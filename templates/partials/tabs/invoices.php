		...
		<div class="detail-content">
			<div class="detail-stats">
				<div class="stat-card">
					...
					<div class="stat-card__value" id="invoice-detail-client"></div>
				</div>
				<div class="stat-card">
					<div class="stat-card__label">Toplam</div>
					<div class="stat-card__value" id="invoice-detail-total"></div>
				</div>
				<div class="stat-card">
					<div class="stat-card__label">Ödenen</div>
					<div class="stat-card__value" id="invoice-detail-paid"></div>
				</div>
				<div class="stat-card">
					<div class="stat-card__label">Kalan</div>
					<div class="stat-card__value" id="invoice-detail-remaining"></div>
				</div>
			</div>
			...
			<div class="invoice-status-actions" style="margin-bottom: 20px; display: flex; gap: 10px; flex-wrap: wrap;">
				...
				<button class="btn btn-sm btn-outline change-invoice-status-btn" data-status="sent">📤
					Gönderildi</button>
				<button class="btn btn-sm btn-outline change-invoice-status-btn" data-status="paid">✅ Ödendi</button>
				<button class="btn btn-sm btn-outline change-invoice-status-btn" data-status="overdue">⚠️
					Gecikmiş</button>
				<button class="btn btn-sm btn-outline change-invoice-status-btn" data-status="cancelled">❌
					İptal</button>
			</div>
			...
			<div class="detail-info-card">
				...
				<p class="text-muted" style="margin-bottom: 15px;">Faturaya ait belgeler, ödeme makbuzları, sözleşmeler
					ve diğer dosyalar</p>
				...
				<div class="form-group" style="margin-bottom: 20px;">
					...
					<button type="button" class="btn btn-primary" id="invoice-upload-files-btn"
