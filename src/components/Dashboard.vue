...
export default {
    ...
    methods: {
        ...
        async loadDashboardData() {
            try {
                const [clients, domains, hostings, websites, projects, tasks, invoices, transactions, debts] = await Promise.all([
        ...
        calculateStats() {
            ...
            this.stats.monthlyIncome = (this.allData.transactions || []).reduce((sum, t) => {
...
.primary-bg { background-color: rgba(0, 130, 201, 0.1); color: var(--color-primary-element); }
...
.info-border { border-left-color: var(--color-primary-element); }
...
.bg-primary { background-color: var(--color-primary-element); }
