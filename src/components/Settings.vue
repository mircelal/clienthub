	...
	data() {
		return {
			...
			availableModules: [
				...
				{ id: 'inventory', label: 'Inventory', icon: 'package-variant', description: 'Inventory management' },
...
.settings-section:hover {
	...
	border-color: var(--color-primary-element-element-light);
}
...
.module-checkbox input[type="checkbox"] {
	...
	height: 20px;
	cursor: pointer;
	accent-color: var(--color-primary-element-element);
	flex-shrink: 0;
}
...
.module-icon {
	...
	height: 44px;
	border-radius: 10px;
	background: linear-gradient(135deg, var(--color-primary-element-element) 0%, var(--color-primary-element-element-light) 100%);
...
.form-control:focus {
	outline: none;
	border-color: var(--color-primary-element-element);
	box-shadow: 0 0 0 3px rgba(var(--color-primary-element-element-rgb), 0.1);
}
...
.module-checkbox input[type="checkbox"]:checked + .module-content .module-icon {
	background: linear-gradient(135deg, var(--color-primary-element-element) 0%, var(--color-primary-element-element-dark) 100%);
	box-shadow: 0 3px 10px rgba(var(--color-primary-element-element-rgb), 0.3);
}

/* Currency item default badge */
.currency-item[data-default="true"] {
	border-color: var(--color-primary-element-element);
	background: linear-gradient(135deg, rgba(var(--color-primary-element-element-rgb), 0.05) 0%, rgba(var(--color-primary-element-element-rgb), 0.02) 100%);
}
...
.currency-item[data-default="true"]::before {
	...
	font-weight: 600;
	color: var(--color-primary-element-element);
	background-color: rgba(var(--color-primary-element-element-rgb), 0.1);
	padding: 2px 8px;
	border-radius: 4px;
...
.checkbox-input:checked + .checkbox-custom::after {
	...
	width: 5px;
	height: 10px;
	border: solid var(--color-primary-element-element-text);
	border-width: 0 2px 2px 0;
	transform: rotate(45deg);
}

.checkbox-input:focus + .checkbox-custom {
	box-shadow: 0 0 0 3px rgba(var(--color-primary-element-element-rgb), 0.2);
}
