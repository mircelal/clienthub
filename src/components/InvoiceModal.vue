		...
		<div class="modal-content modal-large">
			...
			<div class="modal-body">
				<form @submit.prevent="saveInvoice">
					...
					<div class="form-row" v-if="!presetClientId">
	...
	methods: {
		...
		loadInvoice() {
			...
			this.formData = {
				...
				clientId: this.presetClientId || this.invoice.clientId || '',
				...
				projectId: this.invoice.projectId || null,
		...
		async saveInvoice() {
			...
			try {
				const data = {
					...this.formData,
					clientId: this.presetClientId || this.formData.clientId || '',
					// invoiceNumber is auto-generated, don't send it
				...
				// Remove invoiceNumber from data if it's empty (let backend generate it)
