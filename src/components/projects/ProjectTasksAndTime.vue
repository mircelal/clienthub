...
.nc-custom-checkbox input:checked ~ .nc-checkmark { background: var(--color-primary-element); border-color: var(--color-primary-element); }
...
.nc-input-clean:focus { outline: none; border-bottom: 2px solid var(--color-primary-element); }
