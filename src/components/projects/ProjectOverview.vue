...
.primary-bg { background-color: var(--color-primary-element-light); color: var(--color-primary-element); }
.success-bg { background-color: var(--color-success-light); color: var(--color-success); }
.warning-bg { background-color: var(--color-warning-light); color: var(--color-warning); }
.error-bg { background-color: var(--color-error-light); color: var(--color-error); }
.info-bg { background-color: var(--color-background-hover); color: var(--color-text-maxcontrast); }
...
.text-primary { color: var(--color-primary-element); }
...
.header-badge.primary { background-color: var(--color-primary-element); color: var(--color-primary-element-text); }
